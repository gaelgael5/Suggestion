...
namespace Bb.Sdk.QuadTreeSorter
{
    ...
    /// <summary>
    /// Object class for optimize the geometric search
    /// </summary>
    ...
    public class QuadTree<T> where T : class, IQuadObject
    {
        ...
        /// Ctor
        /// </summary>
        /// <param name="minLeafSize">as the size of the map</param>
        /// <param name="maxObjectsPerLeaf">max object per part of the grid</param>
        ...
        /// <summary>
        /// Insert an item in item in the list
        /// </summary>
        ...
        /// <summary>
        /// as a query for a point on the map
        /// </summary>
        ...
        /// <summary>
        /// Return the count of object in the list
        /// </summary>
        /// <returns></returns>
